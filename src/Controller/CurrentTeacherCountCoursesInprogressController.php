...
#[AsController]
class CurrentTeacherCountCoursesInprogressController extends AbstractController
{
    ...
    public function __invoke(Request $request, InstitutionRepository $institutionRepository)
    {
        ...
        $countCourses = $this->teacherCourseRegistrationRepo->countTeacherCoursesInprogress($currentTeacher);
