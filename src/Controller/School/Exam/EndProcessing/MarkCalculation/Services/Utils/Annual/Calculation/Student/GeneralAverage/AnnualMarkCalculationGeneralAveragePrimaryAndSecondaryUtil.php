...
class AnnualMarkCalculationGeneralAveragePrimaryAndSecondaryUtil extends AnnualMarkCalculationUtil
{
...
//        dd($this->calculateGeneralAverageMethod);
    ...
    public function setIsEliminationGeneralAverageActivated(bool $isEliminationGeneralAverageActivated): AnnualMarkCalculationGeneralAveragePrimaryAndSecondaryUtil
    {
    ...
    public function setEliminateAverage(float $eliminateAverage): AnnualMarkCalculationGeneralAveragePrimaryAndSecondaryUtil
    {
    ...
    public function setAnnualMarkGenerationGeneralAverageUtil(AnnualMarkGenerationGeneralAverageUtil $annualMarkGenerationGeneralAverageUtil): AnnualMarkCalculationGeneralAveragePrimaryAndSecondaryUtil
    {
    ...
    function calculateAnnualGeneralAverage(array $markCalculateds, array $studentCourseRegistrationsAttended): MarkAnnualGeneralAverageCalculated
    {
        ...
        $classProgramIds = $this->markAnnualCourseCalculatedRepository->getClassPrograms($this->class);
    ...
    {
        return array_filter($markAnnualCoursesCalculated, fn(MarkAnnualCourseCalculated $markAnnualCourseCalculated) => !$markAnnualCourseCalculated->getIsModuleEliminated());
    }
...
//        dd($total,$totalCredit);
    ...
    function calculateAnnualWeightingAverageIsCoeff0Assign0Activate1(array $markAnnualCoursesCalculated): array|float|null
    {
        ...
        $markAnnualCoursesCalculated = array_filter($markAnnualCoursesCalculated, fn(MarkAnnualCourseCalculated $markAnnualCourseCalculated) => $markAnnualCourseCalculated->getIsModuleEliminated());
