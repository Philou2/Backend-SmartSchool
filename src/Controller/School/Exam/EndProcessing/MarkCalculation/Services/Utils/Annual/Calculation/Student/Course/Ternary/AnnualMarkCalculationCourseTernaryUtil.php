...
class AnnualMarkCalculationCourseTernaryUtil extends AnnualMarkCalculationUtil
{
...
//        $this->calculateMethod = 'calculatePeriodCourseMark'.$this->halfYearAverageFormula;
    ...
    public function setIsEliminationCourseActivated(bool $isEliminationCourseActivated): AnnualMarkCalculationCourseTernaryUtil
    {
    ...
    // On ne calcule pas la note annuelle d'une matiere au superieur
