...
class PeriodMarkTernaryTranscriptGetAllMarksCalculatedUtil
{
    ...
    public function getMarkPeriodCourseCalculatedFormatted(MarkPeriodCourseCalculated $markPeriodCourseCalculated): array
    {
        ...
        if ($this->calculateSubjectsRanks){
            ...
            $rankShowed = isset($rank,$mark) ? ($this->displayNumberOfRows ? $rank.'/'.($this->displayTheClassSizeInRows ? $this->classHeadcount : $totalCourseStudentsRegistered) : $rank) : ($isClassed ? '' : 'not classed');
