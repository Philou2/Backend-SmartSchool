...
use App\Repository\StudentOnline\StudentOnlineRepository;
...
#[AsController]
class RegisterStudentController extends AbstractController
{
    ...
    public function __invoke(Request                     $request,
                             ...
                             StudentOnlineRepository $studentOnlineRepository): JsonResponse|Response
    {
        $id = $request->get('id');
