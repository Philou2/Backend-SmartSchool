...
#[AsController]
class CreateValidatePurchaseInvoiceDeliveryController extends AbstractController
{
            ...
            foreach ($purchaseInvoiceItems as $purchaseInvoiceItem)
            {
                ...
                if ($purchaseInvoiceItemStocks){
                    foreach ($purchaseInvoiceItemStocks as $purchaseInvoiceItemStock)
                    {
                        ...
                        $stock->setReserveQte($stock->getReserveQte() + $deliveryItem->getQuantity());
                    }
                }
