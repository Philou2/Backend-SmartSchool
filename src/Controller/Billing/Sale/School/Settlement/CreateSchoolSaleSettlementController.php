...
#[AsController]
class CreateSchoolSaleSettlementController extends AbstractController
{
...
//        }
        ...
        $settlement->setClass($studentRegistration->getClasse());
        $settlement->setSchool($studentRegistration->getSchool());
