...
#[AsController]
class CurrentTeacherCountCoursesController extends AbstractController
{
    ...
    public function __invoke(Request $request, InstitutionRepository $institutionRepository)
    {
        ...
        $countCourses = $this->teacherCourseRegistrationRepo->countTeacherCourses($currentTeacher);
