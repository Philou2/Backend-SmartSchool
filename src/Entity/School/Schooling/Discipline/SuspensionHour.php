...
use App\Controller\School\Schooling\Discipline\GetSuspensionHoursController;
use App\Controller\School\Schooling\Discipline\PostSuspensionHourController;
...
#[ORM\Entity(repositoryClass: SuspensionHourRepository::class)]
#[ORM\Table(name: 'school_suspension_hour')]
#[ApiResource(
    operations:[
        new Get(
            uriTemplate: '/get/suspension-hours/{id}',
            requirements: ['id' => '\d+'],
            normalizationContext: [
                'groups' => ['get:SuspensionHour:collection'],
            ],
        ),
        new GetCollection(
            uriTemplate: '/get/suspension-hours',
            controller: GetSuspensionHoursController::class,
            order: ['id' => 'DESC'],
            normalizationContext: [
                'groups' => ['get:SuspensionHour:collection'],
            ]
        ...
        new Post(
            uriTemplate: '/create/suspension-hours',
            controller: PostSuspensionHourController::class,
            denormalizationContext: [
                'groups' => ['write:SuspensionHour'],
            ],
        ),
        new Put(
            uriTemplate: '/edit/suspension-hours/{id}',
            requirements: ['id' => '\d+'],
            denormalizationContext: [
                'groups' => ['write:SuspensionHour'],
            ],
        ...
        new Delete(
            uriTemplate: '/delete/suspension-hours/{id}',
            requirements: ['id' => '\d+'],
        ),
    ]
)]

class SuspensionHour
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[Groups(['get:SuspensionHour:collection', 'write:SuspensionHour'])]
    ...
    #[ORM\ManyToMany(targetEntity: StudentRegistration::class, inversedBy: 'suspensionHours')]
    #[ORM\JoinTable(name: 'school_suspension_hour_student_registration')]
    #[Groups(['get:SuspensionHour:collection', 'write:SuspensionHour'])]
