...
use App\Repository\School\Study\Program\CycleYearlyQuotaRepository;
use App\State\Processor\Global\SystemProcessor;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Bridge\Doctrine\Validator\Constraints\UniqueEntity;
use Symfony\Component\Serializer\Annotation\Groups;

#[ORM\Entity(repositoryClass: CycleYearlyQuotaRepository::class)]
#[ORM\Table(name: 'school_cycle_yearly_quota')]
#[ApiResource(
    operations:[
        new Get(
            uriTemplate: '/get/cycle-yearly-quota/{id}',
            requirements: ['id' => '\d+'],
            normalizationContext: [
                'groups' => ['get:CycleYearlyQuota:collection'],
            ],
        ),
        new GetCollection(
            uriTemplate: '/get/cycle-yearly-quota',
            normalizationContext: [
                'groups' => ['get:CycleYearlyQuota:collection'],
            ],
        ...
        new Post(
            uriTemplate: '/create/cycle-yearly-quota',
            denormalizationContext: [
                'groups' => ['write:CycleYearlyQuota'],
            ],
            processor: SystemProcessor::class,
        ),
        new Put(
            uriTemplate: '/edit/cycle-yearly-quota/{id}',
            requirements: ['id' => '\d+'],
            denormalizationContext: [
                'groups' => ['write:CycleYearlyQuota'],
            ],
        ...
        new Delete(
            uriTemplate: '/delete/cycle-yearly-quota/{id}',
            requirements: ['id' => '\d+'],
        ),
        new Delete(
            uriTemplate: '/delete/selected/cycle-yearly-quota',
...
class CycleYearlyQuota
{
    ...
    #[Groups(['get:CycleYearlyQuota:collection', 'write:CycleYearlyQuota'])]
