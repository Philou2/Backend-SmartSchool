...
use App\Repository\School\Study\Program\SpecialityYearlyQuotaRepository;
use App\State\Processor\Global\SystemProcessor;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Bridge\Doctrine\Validator\Constraints\UniqueEntity;
use Symfony\Component\Serializer\Annotation\Groups;

#[ORM\Entity(repositoryClass: SpecialityYearlyQuotaRepository::class)]
#[ORM\Table(name: 'school_speciality_yearly_quota')]
#[ApiResource(
    operations:[
        new Get(
            uriTemplate: '/get/speciality-yearly-quota/{id}',
            requirements: ['id' => '\d+'],
            normalizationContext: [
                'groups' => ['get:SpecialityYearlyQuota:collection'],
            ],
        ),
        new GetCollection(
            uriTemplate: '/get/speciality-yearly-quota',
            normalizationContext: [
                'groups' => ['get:SpecialityYearlyQuota:collection'],
            ],
        ...
        new Post(
            uriTemplate: '/create/speciality-yearly-quota',
            denormalizationContext: [
                'groups' => ['write:SpecialityYearlyQuota'],
            ],
            processor: SystemProcessor::class,
        ),
        new Put(
            uriTemplate: '/edit/speciality-yearly-quota/{id}',
            requirements: ['id' => '\d+'],
            denormalizationContext: [
                'groups' => ['write:SpecialityYearlyQuota'],
            ],
        ...
        new Delete(
            uriTemplate: '/delete/speciality-yearly-quota/{id}',
            requirements: ['id' => '\d+'],
        ),
        new Delete(
            uriTemplate: '/delete/selected/speciality-yearly-quota',
...
#[UniqueEntity(
    fields: ['speciality','year'],
    message: 'this year already exist',
    errorPath: 'speciality'
)]
class SpecialityYearlyQuota
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[Groups(['get:SpecialityYearlyQuota:collection', 'write:SpecialityYearlyQuota'])]
