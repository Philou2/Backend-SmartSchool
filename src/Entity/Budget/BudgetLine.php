...
class BudgetLine
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['get:BudgetLine:collection','get:Budget:collection','get:Needs:collection','get:BudgetReview:collection', 'get:BudgetHistory:collection'])]
    private ?int $id = null;
    ...
    #[Groups(['get:BudgetLine:collection', 'write:BudgetLine','get:Budget:collection','get:Needs:collection', 'get:BudgetReview:collection', 'get:BudgetHistory:collection'])]
