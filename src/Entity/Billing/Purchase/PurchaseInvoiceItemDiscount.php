...
#[ORM\Entity(repositoryClass: PurchaseInvoiceItemDiscountRepository::class)]
#[ORM\Table(name: 'purchase_invoice_item_discount')]
#[ApiResource(
    operations:[
        new GetCollection(
            uriTemplate: '/get/purchase-invoice-item-discount',
            normalizationContext: [
                'groups' => ['get:PurchaseInvoiceItemDiscount:collection'],
            ],
        ),
    ]
)]
class PurchaseInvoiceItemDiscount
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
