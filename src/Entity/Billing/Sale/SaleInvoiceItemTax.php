...
#[ORM\Entity(repositoryClass: SaleInvoiceItemTaxRepository::class)]
#[ORM\Table(name: 'sale_invoice_item_tax')]
#[ApiResource(
    operations:[
        new GetCollection(
            uriTemplate: '/get/sale-invoice-item-tax',
            normalizationContext: [
                'groups' => ['get:SaleInvoiceItemTax:collection'],
            ],
        ),
    ]
)]
class SaleInvoiceItemTax
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
