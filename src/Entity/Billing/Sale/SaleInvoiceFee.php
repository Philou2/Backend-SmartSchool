...
use App\Controller\Billing\Sale\School\Invoice\DeleteSaleInvoiceFeeController;
...
#[ORM\Entity(repositoryClass: SaleInvoiceFeeRepository::class)]
#[ORM\Table(name: 'sale_invoice_fee')]
#[ApiResource(
    operations:[
        new GetCollection(
            uriTemplate: '/get/sale-invoice-fee',
            normalizationContext: [
                'groups' => ['get:SaleInvoiceFee:collection'],
            ],
        ),
        new Get(
            uriTemplate: '/get/sale-invoice/fee/{id}',
            normalizationContext: [
                'groups' => ['get:SaleInvoiceFee:collection'],
            ],
        ),
        new Post(
            uriTemplate: '/create/sale-invoice-fee',
            denormalizationContext: [
                'groups' => ['write:SaleInvoiceFee'],
            ],
            processor: SystemProcessor::class,
        ),
        new Put(
            uriTemplate: '/edit/sale-invoice-fee/{id}',
            requirements: ['id' => '\d+'],
            denormalizationContext: [
                'groups' => ['write:SaleInvoiceFee'],
            ],
        ...
        new Delete(
            uriTemplate: '/delete/sale-invoice-fee/{id}',
            requirements: ['id' => '\d+'],
            controller: DeleteSaleInvoiceFeeController::class
        ),
    ]
)]
class SaleInvoiceFee
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['get:SaleInvoiceFee:collection','get:SaleInvoiceFeeTax:collection'])]
    private ?int $id = null;
    ...
    #[Groups(['get:SaleInvoiceFee:collection', 'write:SaleInvoiceFee'])]
    #[ORM\JoinTable(name: 'sale_invoice_fee_tax')]
    private Collection $taxes;

    #[ORM\Column(length: 100, nullable: true)]
    #[Groups(['get:SaleInvoiceFee:collection', 'write:SaleInvoiceFee','get:SaleInvoiceFeeTax:collection'])]
