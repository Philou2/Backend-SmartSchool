...
use App\Repository\Billing\School\DiscountRepository;
use App\State\Processor\Global\SystemProcessor;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Serializer\Annotation\Groups;

#[ORM\Entity(repositoryClass: DiscountRepository::class)]
#[ORM\Table(name: 'billing_school_discount')]
#[ApiResource(
    operations:[
        new GetCollection(
            uriTemplate: '/get/discount',
            normalizationContext: [
                'groups' => ['get:Discount:collection'],
                'datetime_format'=> 'Y-m-d'
            ],
        ),
        new Post(
            uriTemplate: '/create/discount',
            denormalizationContext: [
                'groups' => ['write:Discount'],
            ],
            processor: SystemProcessor::class,
        ),
        new Put(
            uriTemplate: '/edit/discount/{id}',
            requirements: ['id' => '\d+'],
            denormalizationContext: [
                'groups' => ['write:Discount'],
                'datetime_format'=> 'Y-m-d'
        ...
        new Delete(
            uriTemplate: '/delete/discount/{id}',
            requirements: ['id' => '\d+'],
        ),
    ]
)]
class Discount
{
    ...
    #[ORM\ManyToOne]
    #[Groups(['get:Discount:collection', 'write:Discount'])]
