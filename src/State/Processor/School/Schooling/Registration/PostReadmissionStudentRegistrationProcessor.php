...
class PostReadmissionStudentRegistrationProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = [])
    {
        ...
        foreach($allStudent as $stt){
            ...
            if ($studentRegistrationTaken->getStudent()->getId()) {
                $studentRegistrationTaken->getStudent()->setStatus('registered');
                $studentRegistrationTaken->setStatus('registered');
            }
