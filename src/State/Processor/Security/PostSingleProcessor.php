...
class PostSingleProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = [])
    {
        ...
        if ($data instanceof Menu){
            ...
            $singlePosition = $donnee->position;
            if ($singlePosition){
                $singleMenu = $this->menuRepository->findOneBy(['module' => $module, 'position' => $singlePosition]);
                if ($singleMenu !== null){
