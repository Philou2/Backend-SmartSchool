...
//    }
     ...
     * @return Item[] Returns an array of Item objects
     */
    public function findItemWhereSchool(): array
    {
        return $this->createQueryBuilder('i')
            ->andWhere('i.fee IS NOT NULL')
            ->orderBy('i.id', 'ASC')
            ->getQuery()
            ->getResult()
            ;
     ...
     * @return Item[] Returns an array of Item objects
     */
    public function findItemWhereFeeByClass($class): array
    {
        return $this->createQueryBuilder('i')
            //->andWhere('i.fee IS NOT NULL')
            ->innerJoin('i.fee', 'f', 'WITH', 'f.id = i.fee')
